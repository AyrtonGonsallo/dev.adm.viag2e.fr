...
class TotalGenerator
{
    ...
    public function generateFile(DestinataireFacture  $dest,float  $somme,array $factures, array $parameters,string $date,string $current_day)
    {
        ...
        try {
            ...
            $pdf->writeHTML($this->twig->render('invoices/total_r.html.twig', ['pdf_logo_path' => $this->pdf_logo, 'parameters' => $parameters, 'dest' => $dest,'somme'=>$somme,'factures'=>$factures,'date'=>$date,'current_day'=>$current_day]));
    ...
    public function generateFile2(DestinataireFacture  $dest,float  $somme,array $factures, array $parameters,string $date,string $current_day)
    {
        ...
        try {
            ...
            $pdf2->writeHTML($this->twig->render('invoices/total_h.html.twig', ['pdf_logo_path' => $this->pdf_logo, 'parameters' => $parameters, 'dest' => $dest,'somme'=>$somme,'factures'=>$factures,'date'=>$date,'current_day'=>$current_day]));  
