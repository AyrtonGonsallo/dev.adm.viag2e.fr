...
class PropertyFormType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('date_chaudiere', DateType::class, ['required' => false, 'format' => 'dd-MMM-yyyy','years' => range(date("Y")-3, date("Y")+7) ])
            ->add('date_cheminee', DateType::class, ['required' => false, 'format' => 'dd-MMM-yyyy','years' => range(date("Y")-3, date("Y")+7) ])
            ->add('date_climatisation', DateType::class, ['required' => false, 'format' => 'dd-MMM-yyyy','years' => range(date("Y")-3, date("Y")+7) ])
            ...
            ->add('date_assurance_habitation', DateType::class, ['required' => false, 'format' => 'dd-MMM-yyyy','years' => range(date("Y")-3, date("Y")+7) ])
